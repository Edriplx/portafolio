  ...
  const projects = [
    {
      ...
      subtitle: "Unity - VR",
      description: "Juegos tradicionales ecuatorianos recreados en Unity VR, diseñados para preservar y compartir experiencias culturales a través de la realidad virtual.",
      images: [Vr1, Vr2, Vr3],
    ...
    },
    {
      ...
      subtitle: "React",
      description: "Proyecto desarrollado en React que ayuda a los estudiantes a calcular resultados relacionados con el Movimiento Rectilíneo Uniforme.",
